...
- **[Holesail](holesail.md)** — Direct peer-to-peer encrypted tunnels with no port forwarding, static IPs, or Root CA trust required. Once connected, speeds are comparable to VPN. Works behind restrictive networks and [CGNAT](cgnat.md). Requires installing the **Holesail** service from the marketplace.
